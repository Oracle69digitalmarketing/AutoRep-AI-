...
exports.InfraModule = InfraModule = __decorate([
    (0, common_1.Module)({
        providers: [dynamodb_service_1.DynamodbService, s3_service_1.S3Service, sqs_service_1.SqsService],
        exports: [dynamodb_service_1.DynamodbService, s3_service_1.S3Service, sqs_service_1.SqsService],
    })
], InfraModule);
